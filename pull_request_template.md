...
|------------------------|---------------------------------------------------------------|-------------------------------------------------------------------------------------|---------------|------------|--------------------|
| 2022-00-00             | [operations](https://github.com/USDOT-SDC/operations) | [0.0.0 vs 0.0.1](https://github.com/USDOT-SDC/operations/compare/0.0.0...0.0.1) | Fast Track    | Low        | None               |

## Release
> __Instructions__
> - Don’t forget to move the tag to the head of the main branch after the Pull Request is merged
- https://github.com/USDOT-SDC/operations/releases/tag/0.0.1

## Release Notes
> __Instructions__
> - Provide link to the Release Notes file
- [Release Notes](https://github.com/USDOT-SDC/operations/blob/0.0.1/RELEASE-NOTES.md)
...
__Subject__  
Secure Data Commons: Upcoming Release, 2022-00-00, Operations: Release Title

__Body__  
Secure Data Commons Community:
We are making changes to the Secure Data Commons' (SDC) Operations this week. Deployment of this release will occur on Xday, Month DD, 2020 from x pm to x pm ET. 
Connectivity to the SDCs' Operations will be <available or unavailable> during this deployment window. 
...
__Subject__  
Secure Data Commons: Update, Operations: Release Title  
__Body__  
Secure Data Commons Community:
We have successfully deployed the latest changes to the Secure Data Commons' (SDC) Operations.
...
- [Process: Development](https://securedatacommons.atlassian.net/wiki/spaces/DO/pages/1332379871)
  - [Procedure: Operations](https://securedatacommons.atlassian.net/wiki/spaces/DO/pages/2550693889)
    - [WI: Operations, Operations Deployment](https://securedatacommons.atlassian.net/wiki/spaces/DO/pages/2550726657)
...
- https://github.com/USDOT-SDC/operations/tree/0.0.1/plans
